...
## المتطلبات المسبقة
- الدوال والأصناف والاستثناءات والوحدات والبيئات الافتراضية من الفصول 11–16.
- بيئة محلية منشطة؛ يحتاج تثبيت `pytest` و`pytest-cov` إلى الوصول إلى الحزم مرة واحدة.

## توقّع قبل التشغيل
قبل تشغيل الاختبار الأول، توقّع حالته وأصغر تغيير في الشيفرة يجعله يفشل. شغّل النسختين، ولاحظ رسالة التشخيص، ثم أعد السلوك الناجح قبل المتابعة.
