...
- استكشاف كائن مجهول من دون تعطيل البرنامج.
- قراءة السمات بأمان واكتشاف الإمكانات باستخدام `callable` و`hasattr`.
...
## المتطلبات المسبقة
الفصول السابقة الموصى بها: 2, 11, 12, 14 (و18 للقسم الإضافي).
