...
- **المسار الأساسي · 40–55 دقيقة:** الأقسام 1–3 والتمرين 9-1. النتيجة: تطبيع النص وتحويل عدد صحيح والتعافي من إدخال غير صالح.
...
اطلب اسمًا وعمرًا. توقّع نوعيهما الأوليين، وطبّع الاسم، وحوّل العمر، وتعافَ من عمر غير صالح برسالة واضحة وعدد محاولات محدود. لا تخزن معلومات شخصية حقيقية؛ استخدم اسمًا خياليًا وتخلص من القيم عند انتهاء البرنامج.

امنح نفسك نقطة لكل معيار:
- **الصحة:** ينتج الإدخال الصالح الاسم المطبع والعمر الصحيح المتوقعين.
- **سهولة القراءة:** توضح رسائل الطلب التنسيق وتفصل المتغيرات القيم الخام عن المحولة.
- **معالجة الخطأ:** يحصل الإدخال غير الصالح على رسالة مفيدة ويظل عدد المحاولات محدودًا.
- **التحقق:** تختبر إدخالًا صالحًا وفارغًا وغير رقمي وتسجل الفرع المشاهد.
- **الشرح:** تشرح لماذا تبدأ كل قيم `input()` كنصوص.

يضيف المسار الاحترافي الاختياري فحصين: لا تغادر العناوين `notes/` ولا تستبدل ملفًا، وتبقى حقول CSV المقتبسة حقلًا واحدًا.
