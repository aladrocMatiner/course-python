...
- [x] 1.4 Versionar y migrar los leaves de fuente/locale con reviews independientes.
...
- [x] 1.5 Implementar la proyección determinista de revisión de capítulo/apéndice.
