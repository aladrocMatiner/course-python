...
- Ejecutar el trabajo en lotes revisables de como máximo dos unidades y dos idiomas localizados, con una fuente inglesa congelada y evidencia de revisión por lote. Las tareas de seguimiento que agrupan capítulos 23–25 orquestan dos oleadas atómicas independientes: capítulo 23 y capítulos 24–25.
...
- Affected quality evidence: inventario y registros de revisión por lote; señales del gate común implementado por `add-book-quality-gates` y plugins explícitos de capítulo.
