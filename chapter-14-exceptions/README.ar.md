...
## المتطلبات المسبقة
- الدوال والشروط والأصناف والملفات ومديرو السياق من الفصول 8–13.
- بيئة محلية بإصدار CPython 3.11 أو أحدث؛ يلزم `pytest` لقسم الاختبار فقط.

## توقّع قبل التشغيل
في أول `try/except`، توقّع السطر الذي سيتوقف عن التنفيذ، وأي handler سيعمل، وما إذا كان البرنامج سيتابع بعد ذلك. ثم شغّله واشرح أي فرق بين توقّعك وتدفق التحكم الذي لاحظته.
